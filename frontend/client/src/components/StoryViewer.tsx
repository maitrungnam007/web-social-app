  ...
  return (
    <div className="fixed inset-0 bg-black/80 flex items-center justify-center z-50">
      ...
      <div className="flex items-center gap-4">
        {/* Navigation Left */}
        <div className="w-12 h-12 flex-shrink-0 -mt-8">
          {currentIndex > 0 && (
            <button
              onClick={handlePrev}
        ...
        {/* Story Container */}
        <div className="relative w-[420px] h-[90vh] max-h-[90vh] flex-shrink-0 rounded-xl overflow-hidden">
          {/* Progress Bar */}
          ...
          <div className="absolute top-6 left-3 z-10 flex items-center gap-2">
            ...
            <div className="flex flex-col">
              ...
              <span className="text-white/70 text-xs">{formatTimeAgo(currentStory.createdAt)}</span>
            </div>
          </div>
          ...
          <button
            onClick={onClose}
            className="absolute top-6 right-3 z-10 w-8 h-8 flex items-center justify-center text-white"
          >
          ...
          <button
            ...
            className="absolute top-6 right-12 z-10 w-8 h-8 flex items-center justify-center text-white"
          >
            {isPaused ? (
            ...
            <div className="absolute bottom-4 right-4 flex gap-2">
              {showAddToHighlight && onAddToHighlight && (
                <button
                  ...
                  className="bg-white/20 hover:bg-white/30 text-white px-3 py-1.5 rounded-lg text-sm flex items-center gap-1"
                >
